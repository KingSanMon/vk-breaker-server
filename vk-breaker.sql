...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 29, 2023 at 08:51 PM
...
CREATE TABLE `hacked` (
  `id` int NOT NULL,
  `account_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `ip_address` varchar(13) COLLATE utf8mb4_general_ci NOT NULL,
